...
import { X, Plus, Trash2, Folder, Check, Search, Building2, Calendar, FileText } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        {/* Footer info */}
        <div className="p-3 border-t border-white/10 bg-[#151515] text-[11px] text-gray-400 text-center">
